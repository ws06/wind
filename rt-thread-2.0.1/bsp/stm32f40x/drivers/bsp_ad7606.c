...
/* 启动AD转换的GPIO : PF3  , PH12/TIM5_CH3/DCMI_D3 */
#define CONVST_1()	GPIOF->BSRRL = GPIO_Pin_3
#define CONVST_0()	GPIOF->BSRRH = GPIO_Pin_3
...
/* AD7606复位口线 : PF5  */
#define RESET_1()	GPIOF->BSRRL = GPIO_Pin_5
#define RESET_0()	GPIOF->BSRRH = GPIO_Pin_5
...
//	g_tAD7606.sNowAdc[7] = AD7606_RESULT();	/* 读第8路样本 */
	g_tAD7606.sNowAdc[0] = *(__IO uint16_t *)0x6C400000;
	g_tAD7606.sNowAdc[1] = *(__IO uint16_t *)0x6C400001;
	g_tAD7606.sNowAdc[2] = *(__IO uint16_t *)0x6C400002;
	g_tAD7606.sNowAdc[3] = *(__IO uint16_t *)0x6C400003;
	g_tAD7606.sNowAdc[4] = *(__IO uint16_t *)0x6C400004;
	g_tAD7606.sNowAdc[5] = *(__IO uint16_t *)0x6C400005;
	g_tAD7606.sNowAdc[6] = *(__IO uint16_t *)0x6C400006;
	g_tAD7606.sNowAdc[7] = *(__IO uint16_t *)0x6C400007;
}
